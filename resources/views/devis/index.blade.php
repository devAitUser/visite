                  ...
                  <div class="col-md-12">
                      <div class="card">
                          <div class="card-header  gradient-purple-indigo  0-hidden pb-80">
                             <div class="pt-4">
                              <div class="row">
                                  <h4 class="col-md-4 text-white">devis</h4>
                                          ...
                                          <div class="card">
                                             ...
                                             <v-card>
                                                ...
                                                <v-card-title class="text-right">
                                                    ...
                                                    <a href="{{url('devis/create')}}"  class="btn btn-primary btn-md m-1 text-white "><i class="nav-icon i-Shopping-Basket"></i>    Nouveau  </a>
