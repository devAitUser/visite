...
<html lang="en">
    ...
    <body>
        <div class="auth-layout-wrap" style="background-image: url({{asset('assets/images/photo-wide-3.jpg')}})">
                        ...
                        <div class="col-md-12">
                            <div class="p-4">
                                <div class=" text-center">
                                    <img src="{{asset('assets/images/logo-app.png')}}" alt="">
                                </div>
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <button class="btn btn-rounded btn-primary btn-block mt-2">Connecter</button>
